...
// Run marked
console.log(marked.parse('![Figures of John Mauchly](images/image3.png "John Mauchly size:100%")'));

console.log(marked.parse('![Figures of John Mauchly](images/image3.png "John Mauchly")'));
