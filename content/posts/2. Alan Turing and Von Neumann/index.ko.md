...
![앨런 튜링이 두 손을 등 뒤로 모은 채 생각에 잠겨 걷는다.](images/pdf_walking_ko.webp "size:90%")
...
![한 작업자가 0과 1이 적힌 긴 종이테이프를 손으로 기계에 통과시킨다.](images/pdf_tape_ko.webp "size:90%")
...
![한 여성이 대형 영국 봄브에 여러 줄로 배열된 회전 드럼을 조작한다.](images/pdf_bombe_ko.webp "제2차 세계대전 당시 영국에서 제작된 봄브 size:80%")
:::
...
![국립물리연구소 관계자가 문서가 쌓인 책상에서 보고서를 읽는다.](images/pdf_report_arrives_ko.webp "size:90%")
...
![앨런 튜링이 책상을 사이에 두고 영국 국립물리연구소 관계자와 컴퓨터 설계를 논의한다.](images/pdf_npl_ko.webp "size:90%")
...
![앨런 튜링이 말아 놓은 설계도를 들고 답답한 표정을 짓는다.](images/pdf_funding_ko.webp "size:90%")
