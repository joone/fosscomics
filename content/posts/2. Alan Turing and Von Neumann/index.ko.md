...
![왼쪽에 앨런 튜링, 오른쪽에 존 폰 노이만의 초상이 나란히 있다.](images/feature.png "size:80%")
...
![앨런 튜링이 두 손을 등 뒤로 모은 채 생각에 잠겨 걷는다.](images/ko_image2.png)
...
![한 작업자가 0과 1이 적힌 긴 종이테이프를 손으로 기계에 통과시킨다.](images/ko_image3.png)
...
![프로그래머들이 에니악의 배선판에 케이블을 다시 연결하고, 옆의 동료는 메모를 확인한다.](images/ko_image4.png)
> "이것이 진정한 코딩인가?" \
> "이제 시작이야!"
...
![한 연구자가 캐비닛 크기의 에드박 컴퓨터 옆에 서 있다.](images/ko_image5.png)
> "EDVAC은 최초로 2진수를 사용했습니다."

지금도 모든 컴퓨터는 이와 같은 컴퓨터 구조를 사용하고 있고, 이를 [폰노이만 구조](https://ko.wikipedia.org/wiki/폰_노이만_구조)라고 부른다.

![제어 장치와 산술·논리 장치로 이루어진 CPU가 메모리와 양방향으로 연결된 블록도.](images/ko_image6.png)
...
![폰 노이만의 설계 보고서를 든 연구자가 프로그램 내장형 컴퓨터 옆에서 앨런 튜링과 이야기한다.](images/ko_image7.png)
...
![앨런 튜링이 책상을 사이에 두고 영국 국립물리연구소 관계자와 컴퓨터 설계를 논의한다.](images/ko_image8.png)
...
![앨런 튜링이 말아 놓은 설계도를 들고 답답한 표정을 짓는다.](images/ko_image9.png)
...
![서류 가방을 든 연구자가 방을 가득 채운 에드삭 컴퓨터 옆에 서 있다.](images/ko_image10.png)
...
![존 폰 노이만과 앨런 튜링이 서로 마주 보고 대화한다.](images/ko_image11.png)
...
![연구자가 항의하는 가운데 한 관리가 컴퓨터 장비를 실은 트럭을 밖으로 보낸다.](images/ko_image12.png)
...
![왼쪽부터 앨런 튜링, 존 폰 노이만, 쿠르트 괴델의 초상. 튜링은 프린스턴 대학교에서 박사 학위를 받고 계산의 수학적 모델을 개발했다. 헝가리 출신 이민자인 폰 노이만은 프로그램 내장형 컴퓨터 설계에 참여했다. 오스트리아-헝가리에서 태어나 훗날 미국 시민이 된 괴델의 불완전성 정리는 튜링 기계가 탄생할 이론적 토대를 마련하는 데 기여했다.](images/ko_image13.png)
