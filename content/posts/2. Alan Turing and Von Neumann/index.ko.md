...
![팔짱을 낀 다비트 힐베르트가 말풍선 옆에 서 있다.](images/David_Hilbert.png "David Hilbert(1862-1943)")
...
![앨런 튜링이 두 손을 등 뒤로 모은 채 생각에 잠겨 걷는다.](images/pdf_walking_ko.png)
...
![한 작업자가 0과 1이 적힌 긴 종이테이프를 손으로 기계에 통과시킨다.](images/pdf_tape_ko.png)
...
![한 여성이 대형 영국 봄브에 여러 줄로 배열된 회전 드럼을 조작한다.](images/pdf_bombe_ko.png "제2차 세계대전 당시 영국에서 제작된 봄브")
:::
...
![J. 프레스퍼 에커트와 존 모클리가 나란히 서 있고, 모클리는 팔짱을 끼고 있다.](images/pdf_engineers_ko.png "size:70%")
...
![유리관 안에 금속 전극이 있고 밑부분에 연결 핀이 달린 진공관.](images/pdf_tube_ko.png "size:40%")

![프로그래머가 에니악의 배선판에 케이블을 다시 연결하고, 옆의 동료는 메모를 확인한다.](images/pdf_wiring_ko.png)
> "이것이 진정한 코딩인가?" \
> "이제 시작이야!"
...
![J. 프레스퍼 에커트와 존 모클리가 EDVAC 설계도를 살펴보는 동안 존 폰 노이만이 옆에서 메모한다.](images/pdf_edvac_report_ko.png "J. 프레스퍼 에커트와 존 모클리는 EDVAC을 설계하고 제작한 팀을 이끌었다. 그렇다면 폰 노이만은 어떤 역할을 했을까? size:90%")
...
![국립물리연구소 관계자가 문서가 쌓인 책상에서 보고서를 읽는다.](images/pdf_report_arrives_ko.png)
...
![앨런 튜링이 책상을 사이에 두고 영국 국립물리연구소 관계자와 컴퓨터 설계를 논의한다.](images/pdf_npl_ko.png)
...
![앨런 튜링이 말아 놓은 설계도를 들고 답답한 표정을 짓는다.](images/pdf_funding_ko.png)
> "도대체 영국 정부는 언제 개발비를 주는 거지?" \
> "이렇게 설계도도 있는데..."

케임브리지에서 에드삭 프로젝트를 이끈 모리스 윌크스도 에드박 보고서를 읽었다.

![모리스 윌크스가 책상에서 펼친 보고서를 읽는다.](images/pdf_wilkes_ko.png "size:80%")
...
![서류를 든 연구자가 방을 가득 채운 에드삭 컴퓨터 옆에 서 있다.](images/pdf_edsac_ko.png "EDSAC size:80%")
:::
...
![존 폰 노이만과 앨런 튜링이 서로 마주 보고 대화한다.](images/pdf_conversation_ko.png)
