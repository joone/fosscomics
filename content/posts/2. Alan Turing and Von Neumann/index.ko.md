...
![왼쪽부터 앨런 튜링, 존 폰 노이만, 쿠르트 괴델의 초상. 튜링은 프린스턴 대학교에서 박사 학위를 받고 계산의 수학적 모델을 개발했다. 헝가리 출신 이민자인 폰 노이만은 프로그램 내장형 컴퓨터 설계에 참여했다. 오스트리아-헝가리에서 태어나 훗날 미국 시민이 된 괴델의 불완전성 정리는 튜링 기계가 탄생할 이론적 토대를 마련하는 데 기여했다.](images/ko_2_12.png)
