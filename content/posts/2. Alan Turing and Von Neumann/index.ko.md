...
![컴퓨팅 역사의 인물들이 데스크톱 컴퓨터, 노트북, 스마트폰, 휴대용 게임기가 놓인 탁자 주위에 모여 있다.](images/todays_computers.webp)
...
![팔짱을 낀 다비트 힐베르트가 말풍선 옆에 서 있다.](images/David_Hilbert.webp "다비트 힐베리트(1862-1943)")
...
![유리관 안에 금속 전극이 있고 밑부분에 연결 핀이 달린 진공관.](images/pdf_tube.webp "에니악에 사용된 진공관 size:40%")
:::
