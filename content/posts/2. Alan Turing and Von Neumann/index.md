...
![David Hilbert stands with his arms folded beside a speech bubble.](images/David_Hilbert_en.png "David Hilbert (1862-1943)")
...
![Alan Turing walks with his hands behind his back, deep in thought.](images/pdf_walking_en.png "size:80%")
...
![A worker manually feeds a long paper tape marked with binary symbols through a machine.](images/pdf_tape_en.png "size:80%")
...
![A woman operates rows of rotating drums on a large British Bombe machine.](images/pdf_bombe_en.png "A British-built Bombe used during World War II")
:::
...
![J. Presper Eckert and John Mauchly stand side by side; Mauchly folds his arms.](images/pdf_engineers_en.png "size:70%")
...
![A vacuum tube has metal electrodes inside a glass envelope and connector pins below its base.](images/pdf_tube_en.png "size:40%")

![A programmer reconnects cables on ENIAC's plugboards while a colleague checks notes.](images/pdf_wiring_en.png)
...
![J. Presper Eckert and John Mauchly examine the EDVAC plans while John von Neumann takes notes nearby.](images/pdf_edvac_report_en.png "J. Presper Eckert and John Mauchly led the team that designed and built EDVAC. So what exactly was John von Neumann's role? size:90%")
...
![A character labeled HW waves as a smaller character labeled SW runs away, representing hardware and software.](images/pdf_hardware_software_en.png "size:80%")
...
![An NPL official reads a report at a desk piled with documents.](images/pdf_report_arrives_en.png "size:90%")
...
![Alan Turing discusses computer plans with an NPL official across a desk.](images/pdf_npl_en.png "size:80%")
...
![Alan Turing holds a rolled blueprint with a frustrated expression.](images/pdf_funding_en.png "size:80%")
...
![Maurice Wilkes reads an open report at a table.](images/pdf_wilkes_en.png "size:80%")
...
![A researcher holding a folder stands beside the room-sized EDSAC computer.](images/pdf_edsac_en.png "EDSAC size:80%")
:::
...
![John von Neumann and Alan Turing face one another in conversation.](images/pdf_conversation_en.png "size:80%")
