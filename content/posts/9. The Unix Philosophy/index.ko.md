...
![지팡이를 짚은 수염 긴 노인 모습의 유닉스가 지친 표정을 짓고 있다.](images/9_1.png "size:50%")
> "난 언제 은퇴하나?"
...
![켄 톰프슨과 데니스 리치가 손가락을 하나씩 들고 간결한 설계 원칙을 말한다.](images/9_5.png "size:60%")
> "간단하고 멍청하게 하자."[&lbrack;1&rbrack;][1]

![발표자가 어리둥절한 표정으로 좀 더 제대로 된 설명을 요구한다.](images/9_6.png "size:70%")
> "아니, 농담 말고 진짜 철학을 설명해 주세요."

![톰프슨과 리치, 벨 연구소 동료들이 조금 머뭇거리며 함께 대답한다.](images/9_7.png "size:60%")
> "음... 그냥 만들었는데..."
...
![발표자가 여전히 이해하지 못한 표정으로 머리를 긁적인다.](images/9_8.png "size:60%")
> "그래도 잘 모르겠네."
...
![수염 난 독자가 긴 목록을 바라보며 너무 길다고 생각한다.](images/9_9.png "size:60%")
> "너무 긴데."
...
![발표자가 색색의 장난감 블록을 연결해 더 큰 구조물을 만든다.](images/9_10.png "size:60%")
> "레고 블록처럼!"

레고 블록처럼 유닉스 프로그램은 입력과 출력을 서로 연결해 더 복잡한 도구를 만들 수 있다. 이후 유닉스의 대부분이 C언어로 다시 작성되면서 여러 컴퓨터로 훨씬 쉽게 이식할 수 있게 되었다.

![한 사람이 상자를 들고 떠나자 다른 사람이 뒤에서 부른다.](images/9_11.png "size:80%")
> "물론 유닉스에는 또 다른 장점도 있었지. 소스 코드가 여기저기 돌아다니곤 했거든. 하지만 그 이야기는 다음 기회에..."\
> "어디 가세요?"

![선글라스를 쓴 프로그래머가 유닉스 소스 코드가 담긴 자기 테이프 상자를 들고 간다.](images/9_12.png "size:70%")
