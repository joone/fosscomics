...
![Eric S. Raymond gestures as he introduces his retrospective account of early programmers.](images/6_1.webp "size:70%")
> "In the beginning, there were 'real programmers.'"

![A long-haired, bearded programmer sits cross-legged and imagines rows of binary digits.](images/6_2.webp "size:70%")
> "What is a real programmer?" \
> "Training in machine code for 30 years."

![Raymond points toward two formally dressed programmers working at a large console.](images/6_3.webp "size:90%")
...
![A bearded programmer works at a computer set on a rough log table.](images/6_4.webp "size:80%")
> "Do you know ALGOL or Simula?"

Of course, we must also acknowledge the contributions of women programmers during this period.

![Raymond presents portraits of Margaret Hamilton and Grace Hopper.](images/6_5.webp "size:80%")
...
![Programmers at separate computers are linked by a winding line that represents the spread of shared ideas and software.](images/6_6.webp)
...
![A programmer operates a PDP-1 console while music plays beside its paper-tape reader and typewriter.](images/6_7.webp "PDP-1")
