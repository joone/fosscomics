...
![A long-haired, bearded programmer sits cross-legged and imagines rows of binary digits.](images/6_2.png "size:70%")
> "What is a real programmer?" \
> "Training in machine code for 30 years."

![Raymond points toward two formally dressed programmers working at a large console.](images/6_3.png "size:90%")
...
![A bearded programmer works at a computer set on a rough log table.](images/6_4.png "size:80%")
> "Do you know ALGOL or Simula?"

Of course, we must also acknowledge the contributions of women programmers during this period.

![Raymond presents portraits of Margaret Hamilton and Grace Hopper.](images/6_5.png "size:80%")
...
![Programmers at separate computers are linked by a winding line that represents the spread of shared ideas and software.](images/6_6.png)
...
![A programmer operates a PDP-1 console while music plays beside its paper-tape reader and typewriter.](images/6_7.png "PDP-1")
...
![Several programmers work independently at terminals in a shared computer laboratory.](images/6_8.png "size:80%")
