...
:::panel
![에릭 레이몬드가 초기 프로그래머에 관한 회고를 소개하며 손짓한다.](images/pdf_raymond_ko.webp)
> "태초에 진정한 프로그래머가 있었죠 ..."

![긴 머리와 수염을 한 프로그래머가 가부좌를 틀고 앉아 이진수 행렬을 떠올린다.](images/pdf_real_ko.webp)
> "진정한 프로그래머란 ..." \
> "30년간 기계어로 수련 중"
:::
...
![수염을 기른 프로그래머가 통나무 탁자 위의 컴퓨터로 작업한다.](images/pdf_languages_ko.webp)
> "알골이나 시뮬라를 아나요?"
:::
...
![Joone이 이름표가 붙은 마거릿 해밀턴과 그레이스 호퍼의 초상화를 소개한다.](images/pdf_women_ko.webp)
...
![한 프로그래머가 PDP-1 콘솔을 조작하고, 옆의 종이테이프 판독기와 타자기 위로 음표가 떠오른다.](images/pdf_pdp1_ko.webp)
:::
...
![여러 프로그래머가 공동 컴퓨터 연구실의 각기 다른 단말기에서 작업한다.](images/6_3_ko.webp)
:::
