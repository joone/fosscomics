...
![에릭 레이몬드가 초기 프로그래머에 관한 회고를 소개하며 손짓한다.](images/ko_image6.png)
> “태초에 진정한 프로그래머가 있었죠 ...”

![긴 머리와 수염을 한 프로그래머가 가부좌를 틀고 앉아 이진수 행렬을 떠올린다.](images/ko_image1.png)
> “진정한 프로그래머란 ...” \
> “30년간 기계어로 수련 중”

![레이몬드가 대형 콘솔에서 일하는 정장 차림의 프로그래머 두 명을 가리킨다.](images/ko_image7.png)
...
![레이몬드가 마거릿 해밀턴과 그레이스 호퍼의 초상화를 소개한다.](images/ko_image4.png)
> “태초에 진정한 프로그래머들 상당수는 분명 여성이었을겁니다.”

이러한 진정한 프로그래머들이 만들어 놓은 문화는 대화형 컴퓨팅과 네트워크를 발전시켰고, 오늘날의 오픈 소스 해커 문화에도 영향을 주었다[1].

![각자 다른 컴퓨터를 사용하는 프로그래머들이 소프트웨어와 아이디어의 확산을 나타내는 굽은 선으로 이어져 있다.](images/ko_image2.png)
...
![한 프로그래머가 PDP-1 콘솔을 조작하고, 옆의 종이테이프 판독기와 타자기 위로 음표가 떠오른다.](images/ko_image5.png)
...
![여러 프로그래머가 공동 컴퓨터 연구실의 각기 다른 단말기에서 작업한다.](images/ko_image3.png)
