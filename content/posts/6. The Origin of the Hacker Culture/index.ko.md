...
![에릭 레이몬드가 초기 프로그래머에 관한 회고를 소개하며 손짓한다.](images/6_6_ko.webp)
> "태초에 진정한 프로그래머가 있었죠 ..."

![긴 머리와 수염을 한 프로그래머가 가부좌를 틀고 앉아 이진수 행렬을 떠올린다.](images/6_1_ko.webp)
> "진정한 프로그래머란 ..." \
> "30년간 기계어로 수련 중"

![레이몬드가 대형 콘솔에서 일하는 정장 차림의 프로그래머 두 명을 가리킨다.](images/6_7_ko.webp)
...
![레이몬드가 마거릿 해밀턴과 그레이스 호퍼의 초상화를 소개한다.](images/6_4_ko.webp)
...
![각자 다른 컴퓨터를 사용하는 프로그래머들이 소프트웨어와 아이디어의 확산을 나타내는 굽은 선으로 이어져 있다.](images/6_2_ko.webp)
...
![한 프로그래머가 PDP-1 콘솔을 조작하고, 옆의 종이테이프 판독기와 타자기 위로 음표가 떠오른다.](images/6_5_ko.webp)
