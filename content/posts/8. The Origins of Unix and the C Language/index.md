...
![A programmer at MIT senses a parallel effort at Bell Labs, where two programmers work at a terminal.](images/8_2.webp "MIT vs. Bell Lab.")
...
![Two Bell Labs programmers discuss Multics over cups of coffee.](images/8_3.webp)
...
![A frustrated programmer grips his hair while criticizing the complexity of Multics.](images/8_4.webp "size:80%")
...
![A Bell Labs representative walks away while GE and MIT remain seated with a tall stack labeled Multics.](images/8_5.webp "size:80%")
...
![Ken Thompson and Dennis Ritchie hold small light bulbs while discussing a simpler operating system.](images/8_6.webp)
...
![Thompson carries balloons labeled command-line interpreter, file system, and dynamic linking while Multics holds a larger cluster.](images/8_7.webp)
...
![Thompson, Ritchie, and a colleague contribute ideas for the new file system.](images/8_8.webp)
...
![Ritchie tells Thompson that a PDP-11 has arrived and suggests moving Unix to it.](images/8_9.webp)
...
![Thompson celebrates at a terminal while Ritchie points out the cost of repeated assembly-language ports.](images/8_10.webp "size:90%")
> "Wow, I finally finished the port!" \
> "But we can't rewrite Unix every time a new computer comes along."

![Thompson holds a sheet marked B while considering whether the language could be used for Unix.](images/8_11.webp)
> "Dennis, think we could rewrite Unix in B?" \
> "Maybe. But B still has problems on the PDP-11."

![Ritchie explains that B must first work properly on the PDP-11.](images/8_12.webp "size:80%")
...
![Ritchie works at a PDP-11 terminal while describing a problem with porting B.](images/8_13.webp)
...
![Thompson asks Ritchie about the B port while Ritchie writes at a desk.](images/8_14.webp)
> "Dennis, how's the B language porting going?" \
> "There are a lot of problems. B doesn't handle byte-sized characters well."

![Thompson suggests rebuilding B as Ritchie considers the scale of the task.](images/8_15.webp)
...
![Thompson and Ritchie work together at the PDP-11 and agree on the name C.](images/8_16.webp)
> "How about calling it C?" \
> "Sounds good"

In the summer of 1973, Thompson, Ritchie, and their colleagues rewrote the Unix kernel in C.

![Ritchie types at a terminal after the Unix kernel has been rewritten without assembly language.](images/8_17.webp "size:80%")
...
![A C-themed superhero lifts a UNIX sign while a smaller figure representing assembly language reacts below.](images/8_18.webp "size:80%")
