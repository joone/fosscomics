...
![An installer stands beside a room-sized mainframe while a programmer holding a manual looks uncertain.](images/5_1.webp "Honeywell 800 mainframe, 1959")
> "Installation done!" \
...
![A mathematician fills a board with equations while a programmer waits beside him.](images/5_2.webp "size:80%")
...
![A scientist and a programmer work together at a console in front of a mainframe.](images/5_3.webp "size:90%")
...
![Margaret Hamilton gestures while explaining how early programmers learned their work.](images/5_4.webp "Margaret Hamilton size:70%")
...
![Margaret Hamilton works at a desk while her daughter waits beside a model of the Saturn V rocket.](images/5_5.webp "size:70%")
...
![A spacecraft follows a looping route between Earth and the Moon while Margaret Hamilton celebrates below.](images/5_6.webp)
...
![Margaret Hamilton raises one finger to emphasize a new name for the field.](images/5_7.webp "Margaret Hamilton size:80%")
...
![A woman works at a computer console in front of a large mainframe.](images/5_8.webp "size:80%")
> "The salary is too low for what I'm doing."


![Two male hardware engineers review a large blueprint spread across a table.](images/5_9.webp "Designing hardware")

All the people who did the programming by connecting the functional unit boards at ENIAC were women[&lbrack;3&rbrack;][3].

![Two women program ENIAC by connecting cables on its control panels, with one reading from a sheet of notes.](images/5_10.webp "size:80%")
...
![Grace Hopper stands with her hands on her hips beside the malfunctioning Harvard Mark II.](images/5_11.webp "size:80%")
> "Why isn't the input working?"

The team found a moth trapped in one of the machine's relays.

![Grace Hopper points toward a moth caught among the Harvard Mark II's relays.](images/5_12.webp "size:80%")
...
![Grace Hopper tapes the moth into the team's logbook and writes beside it.](images/5_13.webp "Grace Hopper size:80%")
> "First actual case of bug being found."

Women played a pioneering role in early programming and helped lay the foundations of software engineering.

![Margaret Hamilton stands beside a towering stack of printed Apollo flight software.](images/margaret_hamilton.webp)
