...
![두 기술자가 서로 다른 대형 계산 장치의 제어판을 가리킨다.](images/pdf_machines_ko.webp)
> "독일군 암호 해독을 위한 장치" \
> "이건 사칙연산을 위한 계산기"

![한 사람이 턱을 괸 채 탄도 계산용 컴퓨터를 구상한다.](images/pdf_planning_ko.webp)
> "탄도 계산하는 장치를 만들어 볼까?" \
...
![검은 안경을 쓴 프로그래머가 길게 늘어선 이진수를 살펴본다.](images/pdf_binary_ko.webp)
...
![프로그래머가 모형 로켓을 옆에 두고 책상에서 종이에 코드를 쓴다.](images/pdf_writing_ko.webp)
> "지금은 코딩중"
:::
...
![손에 든 노란색 천공카드 위에 포트란 프로그래밍을 위한 천공카드라고 적혀 있다.](images/pdf_card_ko.webp)
:::
...
![주인공이 옆 사람을 곁눈질하며 천공카드로 옮기기 전의 손글씨 코드를 몰래 베껴 쓴다.](images/pdf_copying_ko.webp)
:::
