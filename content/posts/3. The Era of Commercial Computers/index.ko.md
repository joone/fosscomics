...
![존 모클리와 J. 프레스퍼 에커트가 서로 마주 보고 있으며, 에커트가 손짓하고 있다.](images/pdf_founders_ko.webp)
...
![조지프 매카시 상원의원이 존 모클리를 발로 차서 내쫓고 있다.](images/pdf_expulsion_ko.webp)
> "빨갱이 어서 꺼져!"
:::
...
![도널드 커누스가 IBM 650 컴퓨터의 제어 콘솔 앞에 앉아 있다.](images/pdf_knuth_ko.webp "size:80%")
...
![웃고 있는 트랜지스터들 옆에서 진공관이 은퇴를 이야기하고 있다.](images/pdf_transistors_ko.webp "size:60%")
