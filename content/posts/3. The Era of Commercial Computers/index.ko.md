...
![군인과 컴퓨터 조작원이 대형 계산 장치 옆에서 전화로 대화하고 있으며, 뒤에는 포가 놓여 있다.](images/ko_3_1.png)
> "포탄의 탄도 계산은 완료되었나요?" \
> "계산결과는 아직 안나왔어요."

전쟁이 끝난 뒤, 이 컴퓨터 개발에 참여한 엔지니어 중에서 일찍이 컴퓨터의 상업적 가능성을 미리 예측한 사람들도 있었는데, 컴퓨터가 정부 기관과 기업을 비롯한 민간 조직에도 유용할 수 있다고 생각했다.

![J. 프레스퍼 에커트와 존 모클리가 서로 마주 보고 있으며, 한 사람이 손짓하고 있다.](images/ko_3_2.png)
...
![미래에서 온 Joone가 전화로 이야기하고, 다른 직원은 유니박 콘솔 옆에서 출력을 살펴보고 있다.](images/ko_3_3.png)
> "내일 날씨는 어떤가요?" \
> "잠깐 기다려보세요"
...
![조지프 매카시 상원의원이 존 모클리를 손가락으로 가리키며 몰아세우고, 모클리는 두 손을 펴 보이며 대응하고 있다.](images/ko_3_4.png)
> “빨갱이가 군을 위해 컴퓨터를 만든다고?” \
> “그건 오해요. 우리 직원 중에 공산주의자는 없소”

모클리 역시 의심을 받아 회사를 떠나야 했고, 다시 업무에 복귀하는 데 2년이라는 시간이 걸렸다.

![조지프 매카시 상원의원이 존 모클리를 발로 차서 내쫓고 있다.](images/ko_3_5.png)
> “빨갱이 어서 꺼져!”
...
![타임머신을 타고 1950년대로 온 Joone이 대형 IBM 701 컴퓨터의 콘솔을 살펴보고 있다.](images/ko_3_6.png)
...
![존 배커스가 포트란을 설명하며 손짓하고, Joone은 놀란 표정으로 듣고 있다.](images/ko_3_7.png)
...
![도널드 커누스가 IBM 650 컴퓨터의 제어 콘솔 앞에 앉아 있다.](images/ko_3_8.png)
