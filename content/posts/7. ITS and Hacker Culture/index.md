...
![Three TMRC members stand around a model railroad, considering how to prevent collisions.](images/7_1.webp)
> "How do we keep the trains from crashing?"\
> "Hmm..."\
> "What if we controlled them with the new PDP-1?"

![One club member reacts with surprise as another proposes writing a PDP-1 control program.](images/7_2.webp)
...
![A club member points out the PDP-1's round display while another looks puzzled.](images/7_3.webp "size:80%")
...
![Two programmers work at the PDP-1 late at night beside a stack of pizza boxes.](images/7_4.webp "size:70%")

![A manager sits behind his desk and frowns at the electric bill.](images/7_5.webp "size:70%")
> "How did the electric bill get this high?"

![The manager reads a report and orders the computer room locked while imagining the students at their model railroad.](images/7_6.webp "size:80%")
> "Lock the computer room at night." \
> "They don't study... They should just build model trains."

![Three programmers find the computer-room door locked after hours.](images/7_7.webp "size:90%")
> "Locked out after dinner." \
> "Should've ordered pizza."

![Two students help a reluctant friend climb through a high window.](images/7_8.webp "size:90%")
> "Do I really have to do this?" \
> "Of course. This is history. One of the first computer games is being made right now!"

![The two programmers continue working at the PDP-1 through the night.](images/7_9.webp "size:70%")
...
![A student walks away from the PDP-1 as two others keep working at its display.](images/7_10.webp "size:80%")
...
![Two AI group programmers discuss building their own operating system instead of Multics.](images/7_11.webp "size:80%")
...
![Tom Knight proposes the name ITS to another programmer.](images/7_12.webp)
...
![A programmer writes assembly code beside a PDP-6 console and paper-tape reader.](images/7_13.webp "size:70%")
...
![A smiling ITS user sits at a terminal with a loose cable hanging from it.](images/7_14.webp "size:80%")
> "No password?" \
...
![A line labeled ARPANET connects the MIT AI Lab's PDP-10 to a user at another university.](images/7_15.webp "Access to ITS from other universities")
...
![One programmer hands another a reel containing the ITS source code.](images/7_17.webp "size:80%")
