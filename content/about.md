...
Individual images are often shared on their own. When sharing one, please leave it unedited and uncropped, and link back to [fosscomics.com](https://fosscomics.com) if possible. Project updates are posted at [@fosscomics](https://twitter.com/fosscomics).
...
F/OSS Comics is an independent project. Sponsorship helps cover the domain, drawing equipment, and reference books. The project can be supported through [GitHub Sponsors](https://github.com/sponsors/joone).
